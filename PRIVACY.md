...
3. **Exports (`exports/`)**
   - Markdown files you export
   - Stored indefinitely until you delete them

4. **API Key**
   - Stored in your operating system's secure keyring (macOS Keychain, Windows Credential Manager)
   - Falls back to encrypted SQLite storage on Linux
...
- Stored securely in your OS keyring or encrypted database
...
### Export
- Export individual content to Markdown via the History page
- Copy the entire database file to back up all data

### Delete
- Delete individual items in the History page
- Delete all data by uninstalling (see [INSTALLATION.md](INSTALLATION.md#uninstallation))
...
### API Key Security
- API keys stored in OS keyring are encrypted
- SQLite fallback uses application-level encryption
- Keys are never logged

## Updates

ContentEngine may check for updates (if you enable auto-update), sending only:
...
- Open an issue: [GitHub Issues](https://github.com/YOUR_USERNAME/ContentEngine/issues)
- Email: privacy@yourcompany.com

## Open Source

ContentEngine is open source. You can audit the code:
- Repository: [github.com/YOUR_USERNAME/ContentEngine](https://github.com/YOUR_USERNAME/ContentEngine)
- License: MIT
